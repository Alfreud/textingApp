package com.alfred0ga.texting.chatModule.view.adapters;
...
public class ChatAdapter extends RecyclerView.Adapter<ChatAdapter.ViewHolder> {
    ...
    public ChatAdapter(List<Message> mMessages, OnItemClickListener listener) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        if(message.getPhotoUrl() != null){
            ...
            holder.setClickedListener(message, mlistener);
        }else{
    ...
    static class ViewHolder extends RecyclerView.ViewHolder{
        ...
        private void setClickedListener(Message message, OnItemClickListener listener){
